/* funnel-relay version 2  - do the magic here 2019-07-23 11:00 */
        ...
        trx.MagicLinks = class {
            ...
            init() {
                try {
                    ...
                    //@formatter:off
                    this._envSettings = {"events_recording_env":"nbc","events_recording_api":"https://nymgo12ol2.execute-api.us-east-1.amazonaws.com/Prod","app_key":"gsd65fgr0hgTTT"}; //do not change this token.
                    //@formatter:on

                    //@formatter:off
                    this._serverSettings = {"detection_rules":{"auto":"true","exclude_urls":["facebook.com","google.com","pinterest.com","twitter.com"],"page_url_filter":"","auto_networks":{"amazon":"false","awin":"true","cj":"true","ir":"true","ls":"true","sas":"true","sl":"true","vg":"true","pj":"true","td":"true","wg":"true","pt":"true","dynamic":"true"},"amazon_no_append":"false"},"features":{"append_referrer":{"enabled":"true","attr_name":"referrer"},"attributes_forwarding":{"enabled":"true","attributes":["utm_source","utm_campaign","utm_term","utm_medium","utm_target"]},"append_timing":{"enabled":"false","t_load":"false","t_clicked":"false","t_toclick":"false"},"append_attributes":{"enabled":"false","attributes":""},"track_events":{"enabled":"false","pageview":"false","clicks":"false","analytics_code":"","props_map":{"xid":"prop1","link":"prop2","label":"prop3","referrer":"prop4","origin":"prop5"}},"link_preview":{"enabled":"false","show_icon":"false","show_metadata":"false","show_coupons":"false"},"metadata":{"enabled":"true","selectors":"section | js::jsonLd.Dataset.0.section\narticle_id | js::jsonLd.NewsArticle.0.articleId\necommerce_enabled | js::jsonLd.Dataset.0.ecommerceEnabled\nlabel | js::jsonLd.Dataset.0.label\nsubsection | js::jsonLd.Dataset.0.subSection\nCID | BI.userInfo.get('cid')\nReferrer | BI.userInfo.get('referrer')\n\n"}},"program":{"features":{"append_referrer":{"enabled":"true"},"attributes_forwarding":{"enabled":"true"},"append_timing":{"enabled":"true"},"track_events":{"enabled":"true"},"link_preview":{"enabled":"true","options_state":{"show_icon":"true","show_metadata":"false","show_coupons":"false"}},"append_attributes":{"enabled":"false"},"shorten_extra_param":{"enabled":"false"},"auto_optimize_link":{"enabled":"false"}}},"dynamic_domains":[""]}; //do not change this token.
                    //@formatter:on
            ...
            _linkClicked(link, event) {
                ...
                this._writeDataToEventsService(link, event.type);
            }
             ...
             * @private
             */
            _writeDataToEventsService(link, eventType) {
                //clone the buffer
                let cloneBuffer;
                try {
